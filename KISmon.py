...
IPaddressID='5887d18276254260ec543072'
...
while True: 
	try:
		...
		ipaddressvariable=api.get_variable(IPaddressID)
		...
		time.sleep(10)
IPstr=str(ipgetter.myip())	
IPstr=IPstr.replace('.','')
response=ipaddressvariable.save_value({"value":int(IPstr)})
